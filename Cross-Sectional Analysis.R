...
plot(as.Date(pval_changes$endDate), pval_changes$pval, col='red', pch=19, ylim=c(0,1), 
     xlab="End Date", ylab='Proportion')
points(pval_changes_instKL$endDate, pval_changes_instKL$pval, col='blue', pch=19)
legend('topright', legend=c("Max. Lag=30", "Max. Lag=7"), col=c('red', 'blue'), pch=c(19,19))
